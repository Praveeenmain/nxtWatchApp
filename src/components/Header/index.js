          ...
          >
            {close => (
              <MenuSmModalContainer isDark={isDark}>
                ...
                <NavItems>
                  <NavItem key="home" activeNav={activeNav === 'HOME'}>
                  ...
                  <NavItem key="trend" activeNav={activeNav === 'TREND'}>
                  ...
                  <NavItem key="game" activeNav={activeNav === 'GAME'}>
                  ...
                  <NavItem
                    key="savedVideo"
                    activeNav={activeNav === 'SAVEDVIDEO'}
                  >
  ...
  return (
    <VideoContext.Consumer>
      {value => {
        ...
        return isDark ? HeaderDark(themeBtn) : HeaderLight(themeBtn) // here  desired outut is coming
      }}
    </VideoContext.Consumer>
  )
}
