...
class VideoItemDetails extends Component {
        ...
        {value => {
          ...
          return (
            <VideoBarContainer>
              <ReactPlayerContainer>
                <ReactPlayer
                  url={videoDetails.videoUrl} // Use videoUrl from videoDetails
                  width="100%"
                  controls
                  className="playersm"
                />
  ...
  // The renderVideoBarDark method should be updated similarly.
  ...
  clickRetryBtn = () => {
    this.getVideoDetails() // sir already retry button is there and i change styled-component into normal button
  }
